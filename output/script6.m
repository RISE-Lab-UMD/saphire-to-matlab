...
net.setNodePosition("LPI-PUMPS-CCF",200,140,80,80)
net.addNode(18,"LPI_PUMP_A")
net.setNodePosition("LPI-PUMP-A",200,155,80,80)
net.addNode(18,"LPI_PUMP_B")
net.setNodePosition("LPI-PUMP-B",200,170,80,80)
net.addNode(18,"LPI_VALVES_CCF")
net.setNodePosition("LPI-VALVES-CCF",200,185,80,80)
net.addNode(18,"LPI_VALVE_A")
net.setNodePosition("LPI-VALVE-A",200,200,80,80)
net.addNode(18,"LPI_VALVE_B")
net.setNodePosition("LPI-VALVE-B",200,215,80,80)
net.addNode(18,"LPI_VALVE_C")
net.setNodePosition("LPI-VALVE-C",200,230,80,80)
net.addArc(1,0)
net.addArc(5,0)
net.addArc(3,0)
net.addArc(2,1)
